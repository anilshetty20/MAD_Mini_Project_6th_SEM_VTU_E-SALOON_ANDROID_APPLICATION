...
public class Barber extends AppCompatActivity {
    ...
    private void addListenerOnButton1() {
        ...
        imgButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                String url = "https://www.youtube.com/c/JasonMakki";
    ...
    private void addListenerOnButton3() {
        ...
        imgButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                String url = "https://g.co/kgs/RgdSLf";
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse(url));
                startActivity(i);
            }
    ...
    private void addListenerOnButton4() {
        ...
        imgButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                String url = "https://www.youtube.com/@joeisblu/featured";
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse(url));
                startActivity(i);
            }
...
private void addListenerOnButton8(){
    ...
    imgButton.setOnClickListener(new OnClickListener() {
        ...
        public void onClick(View view) {
            Intent callIntent = new Intent(Intent.ACTION_CALL);
            callIntent.setData(Uri.parse("tel:9148320018"));
            startActivity(callIntent);
        }
    });
}
